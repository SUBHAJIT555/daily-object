  ...
  return (
    <article className="group flex flex-col overflow-hidden rounded-2xl border border-gray-3 bg-white transition-shadow hover:shadow-lg">
      <div className="relative aspect-square overflow-hidden bg-gray-1">
        <Image src={item.img} alt={item.title} fill className="object-contain p-4" sizes="(max-width:640px) 100vw, 25vw" />
        ...
        <div className="absolute right-2 top-2 flex flex-col gap-2 opacity-0 transition-opacity group-hover:opacity-100">
          <button
            ...
            className="flex h-9 w-9 items-center justify-center rounded-full bg-white/95 text-dark shadow hover:text-[var(--color-primary)]"
          >
            <svg
          ...
          <button
            ...
            id="favOne"
            className={`flex h-9 w-9 items-center justify-center rounded-full bg-white/95 shadow ${isInWishlist ? "text-red" : "text-dark hover:text-[var(--color-primary)]"}`}
          >
            <svg
              className="fill-current"
              width="16"
      ...
      <div className="flex flex-1 flex-col p-4">
        <p className="text-xs text-dark-4">({item.reviews} reviews)</p>
        <h3
          className="mt-1 font-semibold text-dark hover:text-[var(--color-primary)] cursor-pointer"
        ...
        <button
          ...
          className="mt-4 w-full rounded-full border-2 border-[var(--color-primary)] bg-transparent py-2.5 text-sm font-medium text-[var(--color-primary)] transition-colors hover:bg-[var(--color-primary)] hover:text-white"
        >
          Add to cart
        </button>
      </div>
