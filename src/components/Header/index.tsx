...
const Header = () => {
  ...
  return (
    <header
      className={`fixed left-0 top-0 z-9999 w-full border-b-2 border-transparent bg-white transition-all duration-300 ${stickyMenu ? "border-[var(--color-primary)] shadow-md" : "border-gray-3/60"}`}
    >
      <div className="max-w-[1170px] mx-auto px-4 sm:px-6 md:px-7.5 xl:px-0">
        {/* <!-- header top start --> */}
        <div
      ...
      <div className="border-t border-gray-3/80">
        <div className="max-w-[1170px] mx-auto px-4 sm:px-6 md:px-7.5 xl:px-0">
          <div className="flex items-center justify-between">
            ...
            <div
              className={`w-[288px] absolute right-4 top-full xl:static xl:w-auto h-0 xl:h-auto invisible xl:visible xl:flex items-center justify-between ${navigationOpen &&
                `!visible bg-white shadow-lg border border-gray-3 !h-auto max-h-[min(400px,70vh)] overflow-y-auto rounded-xl p-5`
                }`}
            >
              {/* <!-- Main Nav Start --> */}
              <nav>
