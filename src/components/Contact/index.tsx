      ...
      <section className="overflow-hidden py-14 sm:py-18">
        <div className="mx-auto max-w-[1170px] px-4 sm:px-6 md:px-8 xl:px-0">
          <div className="grid gap-10 lg:grid-cols-[320px_1fr]">
            <div className="rounded-2xl bg-[var(--color-dark)] p-8 text-white">
              <span className="mb-2 block h-0.5 w-12 bg-[var(--color-primary)]" />
              <h2 className="font-zodiak text-xl font-semibold">
                Contact information
              </h2>
            ...
            <div className="rounded-2xl border border-gray-3 bg-white p-6 sm:p-8 lg:p-10">
              <span className="mb-2 block h-0.5 w-12 bg-[var(--color-primary)]" />
              <h2 className="font-zodiak text-xl font-semibold text-dark">Send a message</h2>
              <form onSubmit={handleSubmit(onSubmit)} className="mt-6">
                <div className="flex flex-col lg:flex-row gap-5 sm:gap-8 mb-5">
                  <div className="w-full">
                    ...
                    <input
                      ...
                      id="firstName"
                      placeholder="Jhon"
                      className={`w-full rounded-full border bg-gray-1 py-3 px-5 outline-none focus:ring-2 focus:ring-[var(--color-primary)] ${errors.firstName ? "border-red" : "border-gray-3"}`}
                    />
                    {errors.firstName && (
                  ...
                  <div className="w-full">
                    ...
                    <input
                      ...
                      id="lastName"
                      placeholder="Deo"
                      className={`w-full rounded-full border bg-gray-1 py-3 px-5 outline-none focus:ring-2 focus:ring-[var(--color-primary)] ${errors.lastName ? "border-red" : "border-gray-3"}`}
                    />
                    {errors.lastName && (
                ...
                <div className="mb-5">
                  ...
                  <input
                    ...
                    className={`w-full rounded-full border bg-gray-1 py-3 px-5 outline-none focus:ring-2 focus:ring-[var(--color-primary)] ${errors.email ? "border-red" : "border-gray-3"}`}
                  />
                  {errors.email && (
                ...
                <div className="flex flex-col lg:flex-row gap-5 sm:gap-8 mb-5">
                  <div className="w-full">
                    ...
                    <input
                      ...
                      className="w-full rounded-full border border-gray-3 bg-gray-1 py-3 px-5 outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
                    />
                  </div>
                ...
                <div className="mb-7.5">
                  ...
                  <textarea
                    ...
                    className="w-full rounded-2xl border border-gray-3 bg-gray-1 p-5 outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
                  ></textarea>
                </div>
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="inline-flex font-medium text-white rounded-full bg-[var(--color-primary)] py-3 px-8 hover:opacity-90 disabled:opacity-60 disabled:cursor-not-allowed"
                >
